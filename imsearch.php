...
<html prefix="og: http://ogp.me/ns#" lang="de-DE" dir="ltr">
	<head>
		...
		<link rel="stylesheet" href="pcss/imsearch.css?17-0-12-1-636857517921167111" media="screen,print" />
		...
		<link rel="icon" href="favicon.png?17-0-12-1-636857517921077200" type="image/png" />
	</head>
	<body>
...
Datenschutz		</a>
	...
	</li><li class="imMnMnMiddle imPage" data-link-paths=",/email-aber-sicher.html">
<div class="label-wrapper">
<div class="label-inner-wrapper">
		<a class="label" href="email-aber-sicher.html">
EMail aber sicher		</a>
</div>
</div>
...
$(function () {$('#imHeader_imMenuObject_22_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imHeader_imMenuObject_22_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imHeader_imMenuObject_22_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
					...
					<div id="imStickyBarContainer">
						...
						<div id="imStickyBar">
							<div id="imStickyBarObjects"><div id="imStickyBar_imObjectImage_01_wrapper" class="template-object-wrapper"><div id="imStickyBar_imObjectImage_01"><div id="imStickyBar_imObjectImage_01_container"><img src="images/GT1_menu_bg_black40-2--1-.png" title="" alt="" />
</div></div></div><div id="imStickyBar_imObjectTitle_02_wrapper" class="template-object-wrapper"><div id="imStickyBar_imObjectTitle_02"><span id ="imStickyBar_imObjectTitle_02_text" >ZOOM</span></div></div><div id="imStickyBar_imMenuObject_03_wrapper" class="template-object-wrapper"><!-- UNSEARCHABLE --><div id="imStickyBar_imMenuObject_03"><div id="imStickyBar_imMenuObject_03_container"><div class="hamburger-button hamburger-component"><div><div><div class="hamburger-bar"></div><div class="hamburger-bar"></div><div class="hamburger-bar"></div></div></div></div><div class="hamburger-menu-background-container hamburger-component">
	<div class="hamburger-menu-background menu-mobile menu-mobile-animated hidden">
		<div class="hamburger-menu-close-button"><span>&times;</span></div>
	</div>
</div>
...
</div><div id="imStickyBar_imObjectImage_04_wrapper" class="template-object-wrapper"><div id="imStickyBar_imObjectImage_04"><div id="imStickyBar_imObjectImage_04_container"><img src="images/GT1_menu_bg_black40-2--1-.png" title="" alt="" />
</div></div></div><div id="imStickyBar_imObjectTitle_05_wrapper" class="template-object-wrapper"><div id="imStickyBar_imObjectTitle_05"><span id ="imStickyBar_imObjectTitle_05_text" >ZOOM</span></div></div><div id="imStickyBar_imMenuObject_06_wrapper" class="template-object-wrapper"><!-- UNSEARCHABLE --><div id="imStickyBar_imMenuObject_06"><div id="imStickyBar_imMenuObject_06_container"><div class="hamburger-button hamburger-component"><div><div><div class="hamburger-bar"></div><div class="hamburger-bar"></div><div class="hamburger-bar"></div></div></div></div><div class="hamburger-menu-background-container hamburger-component">
	<div class="hamburger-menu-background menu-mobile menu-mobile-animated hidden">
		<div class="hamburger-menu-close-button"><span>&times;</span></div>
	</div>
</div>
...
$(function () {$('#imStickyBar_imMenuObject_06_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_06_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_06_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
        ...
        </div></div><div id="imFooter_imObjectTitle_03_wrapper" class="template-object-wrapper"><div id="imFooter_imObjectTitle_03"><span id ="imFooter_imObjectTitle_03_text" >KGSoftware</span></div></div><div id="imFooter_imTextObject_05_wrapper" class="template-object-wrapper"><div id="imFooter_imTextObject_05">
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_05_tab0" style="opacity: 1; ">
		<div class="text-inner">
			<div><b><span class="fs14lh1-5 cf1">Impressum</span></b></div><div><b class="fs12lh1-5 cf1"><br></b></div><div><span class="fs12lh1-5 cf1">Dipl.-Math. Klaus-Peter Gerlach Softwareentwicklung</span><br></div><div><div><span class="fs12lh1-5 cf1">Trebestraße 29<br> D-99438 Bad Berka</span></div><div><br></div><b><span class="fs12lh1-5 cf2 ff1"> </span><!--[if !supportLineBreakNewLine]--><br><span class="fs12lh1-5 cf2 ff1"> </span><!--[endif]--></b></div>
		</div>
	</div>

</div>
</div><div id="imFooter_imObjectTitle_13_wrapper" class="template-object-wrapper"><div id="imFooter_imObjectTitle_13"><span id ="imFooter_imObjectTitle_13_text" >KGSoftware</span></div></div><div id="imFooter_imTextObject_14_wrapper" class="template-object-wrapper"><div id="imFooter_imTextObject_14">
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_14_tab0" style="opacity: 1; ">
		<div class="text-inner">
			<div><br></div><div><br></div><div><span class="fs12lh1-5 cf1">Tel.: (+49) 36458 49 40 8<br></span></div><div><span class="fs12lh1-5 cf1">https://KGSUniversal.GitHub.io</span><br></div><div><span class="fs12lh1-5 cf1">KGSUniversal[at]t-online.de</span></div><div><b><span class="fs12lh1-5 cf2 ff1"> </span><!--[if !supportLineBreakNewLine]--><br><span class="fs12lh1-5 cf2 ff1"> </span><!--[endif]--></b></div>
		</div>
	</div>
