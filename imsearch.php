...
<html prefix="og: http://ogp.me/ns#" lang="de-DE" dir="ltr">
	<head>
		...
		<link rel="stylesheet" href="pcss/imsearch.css?17-0-12-1-636857512365138455" media="screen,print" />
		...
		<link rel="icon" href="favicon.png?17-0-12-1-636857512365083374" type="image/png" />
	</head>
	<body>
...
$(function () {$('#imStickyBar_imMenuObject_06_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_06_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_06_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
	...
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_14_tab0" style="opacity: 1; ">
		<div class="text-inner">
			<div><br></div><div><br></div><div><span class="fs12lh1-5 cf1">Tel.: (+49) 36458 49 40 8<br></span></div><div><span class="fs12lh1-5 cf1">www.KGSUniversal.GitHub.io</span><br></div><div><span class="fs12lh1-5 cf1">KGSUniversal[at]t-online.de</span></div><div><b><span class="fs12lh1-5 cf2 ff1"> </span><!--[if !supportLineBreakNewLine]--><br><span class="fs12lh1-5 cf2 ff1"> </span><!--[endif]--></b></div>
		</div>
	</div>
